...
@click.option(
    ...
    help="The path to the library file to create.",
)
@click.option(
    "library_key",
    "-k",
    type=str,
    help="The key used to identify the library to create.",
)
def cmd(repo: Path, *, library_key: str, library_file: Path) -> None:
    pass
